...
import { INFRA_COLORS as COLORS, LINK_STATUS_COLORS, VLAN_STATE_COLORS, UI_CHROME } from '../../styles/data-viz-colors'
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: UI_CHROME.border, border: `1px solid ${COLORS.border}` }}
      >
...
const inputStyle: React.CSSProperties = {
  background: UI_CHROME.bgOverlay,
  border: `1px solid ${COLORS.border}`,
  color: COLORS.text,
  borderRadius: 4,
  padding: '6px 10px',
...
const btnPrimary: React.CSSProperties = {
  background: LINK_STATUS_COLORS.up,
  color: '#fff',
  border: 'none',
  borderRadius: 4,
  padding: '7px 16px',
...
const btnDanger: React.CSSProperties = {
  background: LINK_STATUS_COLORS.down,
  color: '#fff',
  border: 'none',
  borderRadius: 4,
  padding: '7px 16px',
            ...
            <tr key={v.id} style={{ borderBottom: `1px solid ${COLORS.border}` }}>
              ...
              <td style={{ padding: '8px 12px' }}>
                <span style={{
                  ...
                  color: v.state === 'active' ? VLAN_STATE_COLORS.active : VLAN_STATE_COLORS.inactive,
      ...
      >
        ...
        <button
          ...
          style={{
            fontSize: 10,
            fontFamily: 'JetBrains Mono, monospace',
            background: vlanViewActive ? VLAN_STATE_COLORS.overlay : COLORS.bgCard,
            color: vlanViewActive ? '#fff' : COLORS.text,
            border: `1px solid ${vlanViewActive ? VLAN_STATE_COLORS.overlay : COLORS.border}`,
          ...
          return (
            <g key={`link-${i}`} opacity={linkOpacityOverride}>
              <DataFlowLine
                ...
                color={vlanOverlayInfo != null && !isVlanDimmed ? VLAN_STATE_COLORS.overlay : color}
              ...
              {linkWidthOverride && (
                <line
                  x1={fromPos.x} y1={fromPos.y}
                  x2={toPos.x} y2={toPos.y}
                  stroke={VLAN_STATE_COLORS.overlay}
